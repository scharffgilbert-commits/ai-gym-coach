  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Fitness app custom variants
        gradient: "gradient-primary text-primary-foreground hover:shadow-glow hover:scale-[1.02] active:scale-[0.98]",
        hero: "gradient-primary text-primary-foreground text-lg font-bold shadow-lg hover:shadow-glow hover:scale-[1.02] active:scale-[0.98]",
        workout: "gradient-primary text-primary-foreground text-lg font-bold rounded-2xl shadow-lg hover:shadow-glow hover:scale-[1.02] active:scale-[0.98]",
        success: "bg-success text-success-foreground hover:bg-success/90 hover:scale-[1.02] active:scale-[0.98]",
        glass: "backdrop-blur-xl bg-card/80 text-foreground border border-border/50 hover:bg-card/90 hover:border-primary/30",
      },
      size: {
